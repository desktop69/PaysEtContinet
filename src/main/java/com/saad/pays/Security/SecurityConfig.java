...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/*auth.inMemoryAuthentication().withUser("admin")
		...
		auth.inMemoryAuthentication().withUser("saad")
	...
	http.authorizeRequests().antMatchers("/savePays").hasAnyRole("ADMIN","AGENT");
	http.authorizeRequests().antMatchers("/ListePays")
	.hasAnyRole("ADMIN","AGENT","USER");
	http.authorizeRequests()
	.antMatchers("/supprimerPays","/modifierProduit","/updatePays")
	.hasAnyRole("ADMIN");
